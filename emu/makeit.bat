...
rem Extended Batch Makefile by David KOCH v2.9.2 2013-2019
...
rem	echo %%*>>"%lbat%.%%c.bat"
	echo if %%errorlevel%% neq 0 echo %%errorlevel%%^>"%lerr%.%%c">>"%lbat%.%%c.bat"
)
...
rem							exit /b !verr!
			...
			rem Wait for all processes to exit (might be long if nothing to do)
			call :waitall
