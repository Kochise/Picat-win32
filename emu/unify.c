...
int unify(register BPLONG op1, register BPLONG op2)
{
...
/*
	...
	op2: a var
*/
void unify_nsv_v(register BPLONG op1, register BPLONG op2)
{
	if (op1 != op2) {
		if ((BPULONG)op1 < (BPULONG)op2) {
			FOLLOW(op2) = op1;
...
*/
int unify_lst_lst(register BPLONG op1, register BPLONG op2)
{
	if (op1 == op2) return 1;
	UNTAG_ADDR(op1);
	UNTAG_ADDR(op2);
...
*/
int unify_str_str(register BPLONG op1, register BPLONG op2)
{
	register BPLONG	arity, i;
...
int bp_identical(register BPLONG op1, register BPLONG op2)
{
	register BPLONG_PTR top;
	register BPLONG     arity, i;
