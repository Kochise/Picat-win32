...
#if 0
pset_family form_cover_table(pcover F, pcover D, pset select, int f, int fbar)
		/* indices of f and fbar in the output part */
{
	register	int i;
	register	pcube p;
...
pset_family find_covers(pcover F, pcover D, register pset select, int n)
{
