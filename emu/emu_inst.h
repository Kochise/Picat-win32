...
INSTCASE(allocate_det_b):			/* i, i, s, i */
	AR_B(AR) = (BPLONG)B;
...
INSTCASE(return_det):			/* E */
	RETURN_DET;
	CATCH_WAKE_EVENT;
	CONTCASE;

INSTCASE(unify_constant_return_det):			/* y, c */
	op1 = NextOperandYC;
	...
	SWITCH_OP_ATM(op1, rr_unify_constant_return_det,
		{ PUSHTRAIL(op1);
			FOLLOW(op1) = op2;
			GOTOCASE(return_det); },
		{ if (op1 == op2) { GOTOCASE(return_det); } },
		{ BIND_SUSPVAR_VALUE_AUX(op1, op2);
			GOTOCASE(return_det); });

	BACKTRACK;

INSTCASE(cut_unify_value_return_det):			/* y, y */
	CUT0;

INSTCASE(unify_value_return_det):			/* y, y */
	...
	SWITCH_OP(op1, rr_unify_value_return_det,
		{ SWITCH_OP_VAR(op2, unify_value_return_det_v_d,
			...
			GOTOCASE(return_det); },
		{ UNIFY_CONSTANT_21_CONT(op2, op1, rrr_unify_value_return_det, { PUSHTRAIL(op2); }, { }, { BACKTRACK; }, { GOTOCASE(return_det); }); },
		{ goto unify_lst_d; },
		{ goto unify_str_d; },
		{ goto unify_susp_d; });


INSTCASE(return_nondet):			/* E */
	RETURN_NONDET;
	CATCH_WAKE_EVENT;
	CONTCASE;

INSTCASE(unify_constant_return_nondet):			/* y, c */
	op1 = NextOperandYC;
	op2 = NextOperandLiteral;
	SWITCH_OP_ATM(op1, rr_unify_constant_return_nondet,
		{ PUSHTRAIL(op1);
			FOLLOW(op1) = op2;
			GOTOCASE(return_nondet); },
		{ if (op1 == op2) { GOTOCASE(return_nondet); } },
		{ BIND_SUSPVAR_VALUE_AUX(op1, op2);
			GOTOCASE(return_nondet); });

	BACKTRACK;

INSTCASE(fork_unify_constant_return_nondet):			/* l, y, c */
	{ BPLONG tmp_op;
		...
		SWITCH_OP_ATM(op1, rr_fork_unify_constant_return_nondet,
			{ SET_FORK; PUSHTRAIL(op1);
				FOLLOW(op1) = op2;
				GOTOCASE(return_nondet); },
			{ if (op1 == op2) { SET_FORK; GOTOCASE(return_nondet); } },
			{ SET_FORK;
				BIND_SUSPVAR_VALUE_AUX(op1, op2);
				GOTOCASE(return_nondet); });
...
INSTCASE(fork_unify_nil_unify_value_return_nondet):			/* l, y, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
		SWITCH_OP_NIL(op1, rr_fork_unify_nil_unify_value_return_nondet,
			{ SET_FORK;
				PUSHTRAIL(op1);
				FOLLOW(op1) = nil_sym;
				GOTOCASE(unify_value_return_nondet); },
			{ SET_FORK; GOTOCASE(unify_value_return_nondet); },
			{ SET_FORK;
...
INSTCASE(unify_value_return_nondet):			/* y, y */
	op1 = NextOperandYC;
	op2 = NextOperandYC;
	SWITCH_OP(op1, rr_unify_value_return_nondet,
		{ SWITCH_OP_VAR(op2, unify_value_return_nondet_v_d,
			...
			ASSIGN_in_toam(op1, op2, { PUSHTRAIL(op1); });
			GOTOCASE(return_nondet); },
		{ UNIFY_CONSTANT_21_CONT(op2, op1, rrr_unify_value_return_nondet, { PUSHTRAIL(op2); }, { }, { BACKTRACK; }, { GOTOCASE(return_nondet); }); },
		{ goto unify_lst_d; },
		{ goto unify_str_d; },
		{ goto unify_susp_d; });
...
INSTCASE(call_uv_det):			/* l, y, y, i */
	{ BPLONG_PTR ep;
		...
		*LOCAL_TOP = (BPLONG)AR;
		...
		AR_CPS(AR) = (BPLONG)P;
		P = ep;
		GOTOCASE(allocate_det);
	}

INSTCASE(allocate_det):			/* i, i, s, i */
...
INSTCASE(call_uv_nondet):			/* l, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
		...
		*LOCAL_TOP = (BPLONG)AR;
		...
		AR_CPS(AR) = (BPLONG)P;
		P = ep;
		GOTOCASE(allocate_nondet);
	}

INSTCASE(call_uv_ot):			/* l, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uuv_d):			/* l, y, y, y, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_uuv_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uuv_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_uuv_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uuv_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_uuv_ot];
		GOTOCASE(call_uuv_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_uuv_det):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uuv_nondet):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uuv_ot):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uvv_d):			/* l, y, y, y, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_uvv_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvv_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_uvv_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvv_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_uvv_ot];
		GOTOCASE(call_uvv_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_uvv_det):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvv_nondet):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvv_ot):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvc_d):			/* l, y, y, c, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_uvc_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvc_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_uvc_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvc_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_uvc_ot];
		GOTOCASE(call_uvc_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_uvc_det):			/* l, y, y, c, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvc_nondet):			/* l, y, y, c, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvc_ot):			/* l, y, y, c, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvu_d):			/* l, y, y, y, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_uvu_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvu_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_uvu_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvu_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_uvu_ot];
		GOTOCASE(call_uvu_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_uvu_det):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvu_nondet):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvu_ot):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvuv_d):			/* l, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_uvuv_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvuv_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_uvuv_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uvuv_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_uvuv_ot];
		GOTOCASE(call_uvuv_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_uvuv_det):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvuv_nondet):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uvuv_ot):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
...
INSTCASE(call_uuuv_d):			/* l, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_uuuv_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uuuv_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_uuuv_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uuuv_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_uuuv_ot];
		GOTOCASE(call_uuuv_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_uuuv_det):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uuuv_nondet):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uuuv_ot):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uuuuv_d):			/* l, y, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_uuuuv_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uuuuv_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_uuuuv_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_uuuuv_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_uuuuv_ot];
		GOTOCASE(call_uuuuv_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_uuuuv_det):			/* l, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uuuuv_nondet):			/* l, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_uuuuv_ot):			/* l, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*LOCAL_TOP = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_2u_d):			/* l, y, y, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_2u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_2u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_2u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_2u_nondet);
	} else {
...
INSTCASE(call_2u_nondet):			/* l, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(allocate_nondet):			/* i, i, s, i */
...
INSTCASE(call_3u_d):			/* l, y, y, y, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_3u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_3u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_3u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_3u_nondet);
	} else {
...
INSTCASE(call_3u_det):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_3u_nondet):			/* l, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_4u_d):			/* l, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_4u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_4u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_4u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_4u_nondet);
	} else {
...
INSTCASE(call_4u_det):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_4u_nondet):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_4u_ot):			/* l, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_5u_d):			/* l, y, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_5u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_5u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_5u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_5u_nondet);
	} else {
...
INSTCASE(call_5u_det):			/* l, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_5u_nondet):			/* l, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_5u_ot):			/* l, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_6u_d):			/* l, y, y, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_6u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_6u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_6u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_6u_nondet);
	} else {
...
INSTCASE(call_6u_det):			/* l, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_6u_nondet):			/* l, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_6u_ot):			/* l, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_7u_d):			/* l, y, y, y, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_7u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_7u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_7u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_7u_nondet);
	} else {
...
INSTCASE(call_7u_det):			/* l, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_7u_nondet):			/* l, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_7u_ot):			/* l, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_8u_d):			/* l, y, y, y, y, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_8u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_8u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_8u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_8u_nondet);
	} else {
...
INSTCASE(call_8u_det):			/* l, y, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_8u_nondet):			/* l, y, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_8u_ot):			/* l, y, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_9u_d):			/* l, y, y, y, y, y, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_9u_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_9u_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_9u_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_9u_nondet);
	} else {
...
INSTCASE(call_9u_det):			/* l, y, y, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_9u_nondet):			/* l, y, y, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_9u_ot):			/* l, y, y, y, y, y, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = YC(*(P + 1));
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cu_d):			/* l, c, y, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_cu_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cu_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_cu_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cu_nondet);
	} else {
...
INSTCASE(call_cu_nondet):			/* l, c, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuu_d):			/* l, c, y, y, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_cuu_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cuu_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_cuu_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cuu_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_cuu_ot];
		GOTOCASE(call_cuu_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_cuu_det):			/* l, c, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuu_nondet):			/* l, c, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuu_ot):			/* l, c, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuuu_d):			/* l, c, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_cuuu_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cuuu_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_cuuu_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cuuu_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_cuuu_ot];
		GOTOCASE(call_cuuu_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_cuuu_det):			/* l, c, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuuu_nondet):			/* l, c, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuuu_ot):			/* l, c, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuuuu_d):			/* l, c, y, y, y, y, i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[call_cuuuu_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cuuuu_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[call_cuuuu_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(call_cuuuu_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[call_cuuuu_ot];
		GOTOCASE(call_cuuuu_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(call_cuuuu_det):			/* l, c, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuuuu_nondet):			/* l, c, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(call_cuuuu_ot):			/* l, c, y, y, y, y, i */
	{ BPLONG_PTR ep;
		ep = (BPLONG_PTR)*P;
		*(LOCAL_TOP) = *(P + 1);
		*(LOCAL_TOP - 1) = YC(*(P + 2));
...
INSTCASE(jmpn_eq_constant):			/* y, c, l, l */
	op1 = NextOperandYC;
...
INSTCASE(jmpn_eq_struct):			/* y, s, l, l */
	op1 = NextOperandYC;
...
INSTCASE(jmpn_eq_struct_fetch_v):			/* y, s, l, l, y */
	op1 = NextOperandYC;
	sym_ptr = (SYM_REC_PTR)NextOperandSym;
...
INSTCASE(switch_cons):			/* y, l, l, l, y, y */
	op1 = NextOperandYC;
...
INSTCASE(switch_cons_car):			/* y, l, l, l, y */
...
INSTCASE(switch_cons_910):			/* y, l, l, l */
	op1 = NextOperandYC;
	DEREF2(op1, { P = (BPLONG_PTR)*(P + 1); CONTCASE; });
	if (!ISLIST(op1)) goto rr_switch_cons_nolst;
	sreg = (BPLONG_PTR)UNTAGGED_ADDR(op1);
...
INSTCASE(switch_cons_vv):			/* y, l, l, l, y, y */
	op1 = NextOperandYC;
	DEREF2(op1, { P = (BPLONG_PTR)*(P + 1); CONTCASE; });
	if (!ISLIST(op1)) goto rr_switch_cons_nolst;
	sreg = (BPLONG_PTR)UNTAGGED_ADDR(op1);
...
INSTCASE(jmp_eql_uu_fail):			/* y, y, l */
	op1 = YC(*P++);
	op2 = YC(*P++);
...
INSTCASE(jmpn_var_y_fail0):			/* y, l */
	op1 = YC(*P);
	DEREF2(op1, { P += 2; CONTCASE; });
	if (IS_SUSP_VAR(op1)) { P += 2; CONTCASE; }
	GOTOCASE(fail0);

INSTCASE(jmpn_var_y_ot):			/* y, l */
	op1 = YC(*P);
	DEREF2(op1, { P += 2; CONTCASE; });
	if (IS_SUSP_VAR(op1)) { P += 2; CONTCASE; }
	P = (BPLONG_PTR)*(P + 1);
...
INSTCASE(jmpn_atomic_y):			/* y, l */
	op1 = *(P + 1);
	op1 = FOLLOW(op1);	/* the label */
	#ifdef GCC
	if ((void *)op1 == jmp_table[fail0]) {
		*(void **)(P - 1) = jmp_table[jmpn_atomic_y_fail0];
		GOTOCASE(jmpn_atomic_y_fail0);
	} else {
		*(void **)(P - 1) = jmp_table[jmpn_atomic_y_ot];
		GOTOCASE(jmpn_atomic_y_ot);
	}
	#else
	if (op1 == fail0) {
...
INSTCASE(jmpn_atomic_y_fail0):			/* y, l */
	op1 = YC(*P);
	DEREF2(op1, { GOTOCASE(fail0); });
...
INSTCASE(hash_jmpn_constant):			/* c, l */
	op2 = NextOperandLiteral;
	if (op1 == op2) {
		P++;
		CONTCASE;
...
INSTCASE(hash_branch_constant):			/* c, l, l */
	/* c, l_neq, l_eq */
	op2 = Operand0;
	if (op1 == op2) {
		P = (BPLONG_PTR)*(P + 2);
...
INSTCASE(hash_branch_struct):			/* s, l */
	/* s, l_neq, l_eq */
	op2 = Operand0;
...
INSTCASE(para_uv):			/* y, y */
	*LOCAL_TOP = YC(*P);
	op1 = (BPLONG)Y(*(P + 1)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
	LOCAL_TOP -= 2; P += 2;
	CONTCASE;

INSTCASE(para_uuu):			/* y, y, y */
	*LOCAL_TOP = YC(*P);
	*(LOCAL_TOP - 1) = YC(*(P + 1));
	*(LOCAL_TOP - 2) = YC(*(P + 2));
	LOCAL_TOP -= 3; P += 3;
...
INSTCASE(para_uuuw):			/* y, y, y */
	*LOCAL_TOP-- = NextOperandYC;

INSTCASE(para_uuw):			/* y, y */
	*LOCAL_TOP-- = NextOperandYC;
...
INSTCASE(para_vv):			/* y, y */
	op1 = (BPLONG)Y(*P); *LOCAL_TOP = FOLLOW(op1) = op1;
	op1 = (BPLONG)Y(*(P + 1)); *(LOCAL_TOP - 1) = FOLLOW(op1) = op1;
	LOCAL_TOP -= 2; P += 2;
	CONTCASE;

INSTCASE(para_cuv):			/* c, y, y */
	*LOCAL_TOP = *P;
	*(LOCAL_TOP - 1) = YC(*(P + 1));
	op1 = (BPLONG)Y(*(P + 2)); *(LOCAL_TOP - 2) = FOLLOW(op1) = op1;
	LOCAL_TOP -= 3; P += 3;
...
INSTCASE(para_uu):			/* y, y */
	*LOCAL_TOP = YC(*P);
	*(LOCAL_TOP - 1) = YC(*(P + 1));
	LOCAL_TOP -= 2; P += 2;
	CONTCASE;

INSTCASE(para_uc):			/* y, c */
	*LOCAL_TOP = YC(*P);
	*(LOCAL_TOP - 1) = *(P + 1);
	LOCAL_TOP -= 2; P += 2;
	CONTCASE;
...
INSTCASE(fork_unify_struct):			/* l, y, s */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
		sym_ptr = (SYM_REC_PTR)NextOperandSym;
...
INSTCASE(unify_struct_arg_uv0):			/* y, s, y, y */
	op1 = NextOperandYC;
	sym_ptr = (SYM_REC_PTR)NextOperandSym;
	SWITCH_OP_STRUCT(op1, rr_unify_struct_arg_uv0,
		{ RRCASE(rr_unify_struct_arg_uv0_var)
			PUSHTRAIL(op1);
			FOLLOW(op1) = ADDTAG(H, STR);
			FOLLOW(H++) = (BPLONG)sym_ptr;
			sreg = NULL;
		...
		{ UNTAG_ADDR(op1);
			if (FOLLOW(op1) == (BPLONG)sym_ptr) {
			RRCASE(rr_unify_struct_arg_uv0_str)
				sreg = (BPLONG_PTR) op1 + 1;
				YC(*(P + 1)) = FOLLOW(sreg + 1);
				op1 = FOLLOW(sreg); op2 = YC(*P); P += 2; sreg += 2;
				goto rrr_unify_arg_u; }},
		{ RRCASE(rr_unify_struct_arg_uv0_susp)
			op2 = ADDTAG(H, STR);
			FOLLOW(H++) = (BPLONG)sym_ptr;
			sreg = NULL;
...
INSTCASE(unify_struct_arg_2v0):			/* y, s, y, y */
	op1 = NextOperandYC;
	sym_ptr = (SYM_REC_PTR)NextOperandSym;
...
INSTCASE(unify_struct_arg_v0):			/* y, s, y */
	op1 = NextOperandYC;
	sym_ptr = (SYM_REC_PTR)NextOperandSym;
...
INSTCASE(unify_struct_arg_2u):			/* y, s, y, y */
...
INSTCASE(unify_struct_arg_u):			/* y, s, y */
	op1 = NextOperandYC;
	sym_ptr = (SYM_REC_PTR)NextOperandSym;
...
INSTCASE(unify_struct_arg_c):			/* y, s, c */
	op1 = NextOperandYC;
	sym_ptr = (SYM_REC_PTR)NextOperandSym;
...
INSTCASE(unify_struct_arg_wc):			/* y, s, c */
	op1 = NextOperandYC;
	sym_ptr = (SYM_REC_PTR)NextOperandSym;
...
INSTCASE(unify_arg_list):			/* i, zs(-1)+1 */
	if (sreg == NULL) {
		GOTOCASE(build_arg_list);
	} else {
		op1 = *sreg;
		arity = NextOperandLiteral;
		goto rr_unify_list;
...
INSTCASE(unify_arg_4v0):			/* y, y, y, y */
	if (sreg == NULL) {	/* build mode */
		BUILD_V0;
		BUILD_V0;
		BUILD_V0;
...
INSTCASE(build_arg_c):			/* c */
	FOLLOW(H++) = *P++;
	CONTCASE;


INSTCASE(build_arg_v):			/* y */
	op1 = *P++; BUILD_ARG_V(op1); H++;
	CONTCASE;


INSTCASE(build_arg_struct):			/* s */
	H++;
	*(H - 1) = ADDTAG(H, STR);
	*H++ = NextOperandSym;
	CONTCASE;

INSTCASE(build_arg_list):			/* i, zs(-1)+1 */
	H++;
	*(H - 1) = ADDTAG(H, LST);
	goto rr_build_list;


INSTCASE(build_arg_2c):			/* c, c */
	FOLLOW(H++) = *P++;
	FOLLOW(H++) = *P++;
	CONTCASE;

INSTCASE(build_arg_3c):			/* c, c, c */
	FOLLOW(H++) = *P++;
	FOLLOW(H++) = *P++;
	FOLLOW(H++) = *P++;
	CONTCASE;

INSTCASE(build_arg_v0u):			/* y, y */
	BUILD_V0;
	BUILD_U(r_build_arg_vu);
	CONTCASE;

INSTCASE(build_arg_v0c):			/* y, c */
	BUILD_V0;
	FOLLOW(H++) = *P++;
	CONTCASE;

INSTCASE(build_arg_uv0):			/* y, y */
	BUILD_U(r_build_arg_uv0);
	BUILD_V0;
	CONTCASE;

INSTCASE(build_arg_v0w):			/* y */
	BUILD_V0;
	BUILD_W;
	CONTCASE;

INSTCASE(build_arg_wc):			/* c */
	BUILD_W;
	FOLLOW(H++) = *P++;
	CONTCASE;

INSTCASE(build_arg_4v0):			/* y, y, y, y */
	BUILD_V0;

INSTCASE(build_arg_3v0):			/* y, y, y */
	BUILD_V0;

INSTCASE(build_arg_2v0):			/* y, y */
	BUILD_V0;

INSTCASE(build_arg_v0):			/* y */
	BUILD_V0;
	CONTCASE;


INSTCASE(build_arg_5w):			/* E */
	FOLLOW(H) = (BPLONG)H; H++;


INSTCASE(build_arg_4w):			/* E */
	FOLLOW(H) = (BPLONG)H; H++;


INSTCASE(build_arg_3w):			/* E */
	FOLLOW(H) = (BPLONG)H; H++;

INSTCASE(build_arg_2w):			/* E */
	FOLLOW(H) = (BPLONG)H; H++;

INSTCASE(build_arg_w):			/* E */
	FOLLOW(H) = (BPLONG)H; H++;
	CONTCASE;


INSTCASE(build_arg_4u):			/* y, y, y, y */
	op1 = YC(*P++);  BUILD_ARG_U_VALUE(op1, r_build_arg_4u); H++;

INSTCASE(build_arg_3u):			/* y, y, y */
	op1 = YC(*P++);  BUILD_ARG_U_VALUE(op1, r_build_arg_3u); H++;

INSTCASE(build_arg_2u):			/* y, y */
	op1 = YC(*P++);  BUILD_ARG_U_VALUE(op1, r_build_arg_2u); H++;

INSTCASE(build_arg_u):			/* y */
	op1 = YC(*P++);  BUILD_ARG_U_VALUE(op1, r_build_arg_u); H++;
	CONTCASE;

INSTCASE(unify_list):			/* y, i, zs(-1)+1 */
	op1 = NextOperandYC;
	arity = NextOperandLiteral;
...
INSTCASE(unify_comp_list):			/* y, i, zs(-1) */
	op1 = NextOperandYC;
	arity = NextOperandLiteral;
...
INSTCASE(cut_unify_cons_w):			/* y */
	CUT0;


INSTCASE(unify_cons_w):			/* y */
...
INSTCASE(cut_unify_cons_uu):			/* y, y, y */
	CUT0;

INSTCASE(unify_cons_uu):			/* y, y, y */
...
INSTCASE(cut_unify_cons_uv):			/* y, y, y */
	CUT0;

INSTCASE(unify_cons_uv0):			/* y, y, y */
	op1 = NextOperandYC;
...
INSTCASE(cut_unify_cons_vv):			/* y, y, y */
	CUT0;

INSTCASE(unify_cons_v0v0):			/* y, y, y */
	op1 = NextOperandYC;
...
INSTCASE(cut_unify_cons_vu):			/* y, y, y */
	CUT0;

INSTCASE(unify_cons_v0u):			/* y, y, y */
	op1 = NextOperandYC;
...
INSTCASE(cut_unify_cons_vc):			/* y, y, c */
	CUT0;

INSTCASE(unify_cons_v0c):			/* y, y, c */
	op1 = NextOperandYC;
...
INSTCASE(unify_cons_wv0):			/* y, y */
	op1 = NextOperandYC;
	SWITCH_OP_LST(op1, rr_unify_cons_wv0,
		{ RRCASE(rr_unify_cons_wv0_var)
			PUSHTRAIL(op1);
			FOLLOW(op1) = ADDTAG(H, LST);
			FOLLOW(H) = (BPLONG)H; H++;
			YC(*P++) = FOLLOW(H) = (BPLONG)H; H++;
			CONTCASE; },
		{ RRCASE(rr_unify_cons_wv0_lst)
			sreg = (BPLONG_PTR)UNTAGGED_ADDR(op1);
			YC(*P++) = FOLLOW(sreg + 1);
			CONTCASE; },
		{ RRCASE(rr_unify_cons_wv0_susp)
			op2 = ADDTAG(H, LST);
			FOLLOW(H) = (BPLONG)H; H++;
			YC(*P++) = FOLLOW(H) = (BPLONG)H; H++;
			goto bind_suspvar_value; });
...
INSTCASE(unify_cons_cu):			/* y, c, y */
	op1 = NextOperandYC;
	SWITCH_OP_LST(op1, rr_unify_cons_cu,
		{ RRCASE(rr_unify_cons_cu_var)
			PUSHTRAIL(op1);
			FOLLOW(op1) = ADDTAG(H, LST);
			FOLLOW(H) = *P++; H++;
			op1 = NextOperandYC;
...
INSTCASE(cut_unify_cons_cv):			/* y, c, y */
	CUT0;

INSTCASE(unify_cons_cv0):			/* y, c, y */
	op1 = NextOperandYC;
	SWITCH_OP_LST(op1, rr_unify_cons_cv0,
		{ RRCASE(rr_unify_cons_cv0_var)
			PUSHTRAIL(op1);
			FOLLOW(op1) = ADDTAG(H, LST);
			FOLLOW(H) = *P; H++;
			YC(*(P + 1)) = FOLLOW(H) = (BPLONG)H; H++;
			P += 2;
			CONTCASE; },
		{ RRCASE(rr_unify_cons_cv0_lst)
			sreg = (BPLONG_PTR)UNTAGGED_ADDR(op1);
			YC(*(P + 1)) = FOLLOW(sreg + 1);
			op1 = FOLLOW(sreg); op2 = *P; P += 2;
			goto rrr_unify_arg_c; },
		{ RRCASE(rr_unify_cons_cv0_susp)
			op2 = ADDTAG(H, LST);
			FOLLOW(H) = *P; H++;
			YC(*(P + 1)) = FOLLOW(H) = (BPLONG)H; H++;
			P += 2;
...
INSTCASE(unify_cons_ww):			/* y */
	op1 = NextOperandYC;
	SWITCH_OP_LST(op1, rr_unify_cons_ww,
		{ RRCASE(rr_unify_cons_ww_var)
			PUSHTRAIL(op1);
			FOLLOW(op1) = ADDTAG(H, LST);
			FOLLOW(H) = (BPLONG)H; H++;
			FOLLOW(H) = (BPLONG)H; H++;
			CONTCASE; },
		{ RRCASE(rr_unify_cons_ww_lst)
			CONTCASE; },
		{ RRCASE(rr_unify_cons_ww_susp)
			op2 = ADDTAG(H, LST);
			FOLLOW(H) = (BPLONG)H; H++;
			FOLLOW(H) = (BPLONG)H; H++;
			goto bind_suspvar_value; });
...
INSTCASE(fork_unify_cons):			/* l, y, z, z */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_uu):			/* l, y, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_uv):			/* l, y, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_uc):			/* l, y, y, c */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_uw):			/* l, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_vu):			/* l, y, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_vv):			/* l, y, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_vw):			/* l, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_vc):			/* l, y, y, c */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_cc):			/* l, y, c, c */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_cons_v910):			/* l, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
...
INSTCASE(fork_unify_value):			/* l, y, y */
	{ BPLONG tmp_op;
		tmp_op = NextOperandAddr;
		op1 = NextOperandYC;
		op2 = NextOperandYC;
...
INSTCASE(move_constant):			/* y, c */
	op1 = (BPLONG)NextOperandY;
	op2 = NextOperandConstant;
	FOLLOW(op1) = op2;
	CONTCASE;

INSTCASE(move_struct):			/* y, s */
	op1 = (BPLONG)NextOperandY;
	PUSHTRAIL_s(op1);
	FOLLOW(op1) = ADDTAG(H, STR);
...
INSTCASE(move_struct0):			/* y, s */
	YC(*P++) = ADDTAG(H, STR);
	FOLLOW(H++) = NextOperandSym;
	CONTCASE;

INSTCASE(move_list):			/* y, i, zs(-1)+1 */
	op1 = (BPLONG)NextOperandY;
	PUSHTRAIL_s(op1);
	FOLLOW(op1) = ADDTAG(H, LST);
	rr_build_list:
...
INSTCASE(move_comp_list):			/* y, i, zs(-1) */
	op1 = (BPLONG)NextOperandY;
	arity  = NextOperandLiteral;
	PUSHTRAIL_s(op1);
	FOLLOW(op1) = ADDTAG(H, LST);
...
INSTCASE(setarg0):			/* i, y, z */
	op1 = *P++;
	goto setarg_idd;


INSTCASE(functor):			/* z, z, z */
	op1 = *P++; op2 = *P++; op3 = *P++;
...
INSTCASE(get_clause_copy):			/* y, y, y */
	op1 = NextOperandYC;
	op2 = NextOperandYC;
	op3 = NextOperandYC;
	SAVE_TOP;
...
INSTCASE(last_call):			/* i, s, zs(s(-1)), i */
...
INSTCASE(last_call_d):			/* l, i, i, zs(-1), i */
...
INSTCASE(last_call1_d):			/* l, i, i, zs(-1), i */
	ep = (BPLONG_PTR)NextOperandAddr;
...
INSTCASE(last_call_au_d):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)*P;
	op1 = *ep;
	#ifdef GCC
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[last_call_au_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(last_call_au_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[last_call_au_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(last_call_au_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[last_call_au_ot];
		GOTOCASE(last_call_au_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(last_call_au_det):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)NextOperandAddr;
	op3 = NextOperandLiteral;	/* layout bits */
	arity = *P;
	if (AR_IS_TOP(AR)) {	/* reuse the frame */
...
INSTCASE(last_call_au_nondet):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)NextOperandAddr;
	op3 = NextOperandLiteral;	/* layout bits */
	arity = *P;
	if (AR_IS_TOP(AR)) {	/* reuse the frame */
...
INSTCASE(last_call_au_ot):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)NextOperandAddr;
	op3 = NextOperandLiteral;	/* layout bits */
	arity = *P;
	if (AR_IS_TOP(AR)) {	/* reuse the frame */
...
INSTCASE(last_call1_au_d):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)NextOperandAddr;
	op3 = NextOperandLiteral;	/* nogood arg index, the first arg is indexed 1 */
	arity = *P;
	if (AR_IS_TOP(AR)) {	/* reuse the frame */
...
INSTCASE(last_call0_sa_d):			/* l, i */
	...
	if ((void *)op1 == jmp_table[allocate_det]) {
		*(void **)(P - 1) = jmp_table[last_call0_sa_det];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(last_call0_sa_det);
	} else if ((void *)op1 == jmp_table[allocate_nondet]) {
		*(void **)(P - 1) = jmp_table[last_call0_sa_nondet];
		FOLLOW(P) = (BPLONG)(ep + 1);
		GOTOCASE(last_call0_sa_nondet);
	} else {
		*(void **)(P - 1) = jmp_table[last_call0_sa_ot];
		GOTOCASE(last_call0_sa_ot);
	}
	#else
	if (op1 == allocate_det) {
...
INSTCASE(last_call0_sa_det):			/* l, i */
...
INSTCASE(last_call0_sa_nondet):			/* l, i */
	/* the current and the last call have the same arity */
	if (AR_IS_TOP(AR)) {	/* reuse the frame */
		P = (BPLONG_PTR)*P;
		GOTOCASE(allocate_nondet);
...
INSTCASE(tr_det_call_au):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)*P++;
	op3 = *P++;	/* layout bits */
	arity = *P;
	if (AR_IS_TOP(AR)) {	/* reuse the frame */
...
INSTCASE(tr_det_call1_au):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)NextOperandAddr;
...
INSTCASE(tr_det_call2_au):			/* l, i, i, i, ys(-1), i */
	ep = (BPLONG_PTR)*P++;
...
INSTCASE(tr_nondet_call_au):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)*P++;
	op3 = *P++;	/* layout bits */
	arity = *P;
	if (AR_IS_TOP(AR)) {	/* reuse the frame */
...
INSTCASE(tr_nondet_call1_au):			/* l, i, i, ys(-1), i */
	ep = (BPLONG_PTR)*P++;
...
INSTCASE(tr_nondet_call2_au):			/* l, i, i, i, ys(-1), i */
	ep = (BPLONG_PTR)*P++;
	op2 = *P++;	/* misplaced arg index */
	op3 = *P++;
	arity = *P;
...
INSTCASE(allocate_susp):			/* i, i, s, i */
	op1 = *P++;
...
INSTCASE(trigger_ins_min_max):			/* i */
	op1 = *P++;
...
INSTCASE(trigger_var_any_dom):			/* y */
	op2 = NextOperandYC;
...
INSTCASE(trigger_cg_event_handler):			/* i, y */
...
INSTCASE(interval_consistent_eq):			/* i */
...
INSTCASE(interval_consistent_eq_nocoe):			/* i */
...
INSTCASE(interval_consistent_ge):			/* i */
	op1 = NextOperandLiteral;
	SAVE_AR;
	...
	if (op1 == 0) {
		...
		GOTOCASE(return_delay);
	}

INSTCASE(call_binary_constr_eq):			/* i */
	{
...
INSTCASE(domain_next_inst_yyy):			/* y, y, y */
...
INSTCASE(domain_set_false_yy):			/* y, y */
	op1 = NextOperandYC; DEREF_NONVAR(op1);
...
INSTCASE(domain_min_max_yyy):			/* y, y, y */
	op1 = NextOperandYC; DEREF_NONVAR(op1);
	if (IS_SUSP_VAR(op1)) {
...
INSTCASE(domain_region_min):			/* y, z */
	op1 = NextOperandYC; DEREF_NONVAR(op1);
...
INSTCASE(domain_region_max):			/* y, z */
	op1 = NextOperandYC; DEREF_NONVAR(op1);
	op2 = BP_MININT_1W;
	op3 = *P++; OP_NOVY_DEREF_NONVAR(op3); op3 = INTVAL(op3);
	goto start_domain_region;

INSTCASE(v_in_cv_int):			/* E */
	{ BPLONG tmp_op;
...
INSTCASE(activate_first_agent):			/* y, y */
...
INSTCASE(activate_agents_conjunction):			/* y, y, y */
	{
		BPLONG		op4;
...
INSTCASE(activate_agents_disjunction):			/* y, y, y */
	{ BPLONG op4;
		op1 = NextOperandYC; DEREF(op1);	/* agent list 1 */
		op2 = NextOperandYC; DEREF(op2);	/* agent list 2 */
		op3 = NextOperandYC; DEREF(op3);	/* event object */
...
INSTCASE(table_allocate):			/* i, i, s, i */
...
INSTCASE(table_check_completion):			/* l */
	subgoal_entry = (BPLONG_PTR)GET_AR_SUBGOAL_TABLE(AR);
#if 0
...
INSTCASE(table_neck_no_reeval):			/* E */
	subgoal_entry = (BPLONG_PTR)GET_AR_SUBGOAL_TABLE(AR);
...
INSTCASE(last_tabled_call):			/* E */
	CONTCASE;

INSTCASE(table_cut):			/* l */
...
INSTCASE(table_neck):			/* E */
	/* not used */
	CONTCASE;


INSTCASE(table_eager_consume):			/* E */
...
INSTCASE(domain_nogood_region):			/* y, z, z */
	op1 = NextOperandYC; DEREF_NONVAR(op1);
	op2 = *P++; OP_NOVY_DEREF_NONVAR(op2);
	op3 = *P++; OP_NOVY_DEREF_NONVAR(op3);
	op2 = INTVAL(op2); op3 = INTVAL(op3);
...
INSTCASE(table_mode):			/* i, i, i */
	P += 3;
	CONTCASE;

INSTCASE(asp_decode):			/* y, y, i, ys(-1) */
	printf("asp_decode no longer exists\n");
	exit(0);

INSTCASE(asp_add_tuple):			/* y, i, ys(-1) */
	printf("asp_add_tuple no longer exists\n");
	exit(0);


INSTCASE(set_catcher_frame):			/* E */
	AR_BTM(AR) = (AR_BTM(AR) | CATCHER_FRAME_TAG);
	CONTCASE;

INSTCASE(filter_clauses):			/* y, y, y, y */
