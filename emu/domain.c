...
*/
int c_path_from_to_reachability_test(void) {
...
*/
int b_PATH_FROM_TO_REACHABLE(void)
{
...
*/
int c_integers_intervals_list(void) {
...
/*
	...
	decrement_counters(Counters, J, Es, Xj).
*/
int c_cpcon_decrement_counters(void) {
